# hoominid-forum-tutorialclient

I've followed [nextjs block.vue](https://example.com/) for a while and am fascinated by their work and ability to lightweight command runner for repetitive tasks. If you don't know who nextjs block.vue is:
...
I had a spark where I thought, this should be like an `rollup.config.js` feed. I [reached out](https://twitter.com/user) asking:
